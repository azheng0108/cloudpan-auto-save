...
async function saveMediaSettings() {
    const settings = {
        ...
        tmdb: {
            ...
            scraperSource: document.getElementById('scraperSource').value,
            movieRenameFormat: document.getElementById('movieRenameFormat').value,
            tvRenameFormat: document.getElementById('tvRenameFormat').value
        },
        openai: {
